...
[assembly: ExportRenderer(typeof(CameraPage), typeof(CameraCustomRendererAndroid))]
namespace XamarinApp.Droid.CustomRenderers
{
  public class CameraCustomRendererAndroid : PageRenderer, TextureView.ISurfaceTextureListener
  {
    ...
    public CameraCustomRendererAndroid(Context context) : base(context)
    {
      view = new Android.Views.View(context);
      takePhotoButton = new Android.Widget.Button(context);
      toggleFlashButton = new Android.Widget.Button(context);
      switchCameraButton = new Android.Widget.Button(context);
    }
